export function AwardIcon(props: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95 95" {...props}>
      <defs>
        <radialGradient
          cx="50%"
          cy="66.859%"
...
export function FeatureBgIcon(props: SvgIconProps) {
  return (
...
export function NewsletterIcon(props: SvgIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 86 86" {...props}>
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="prefix__news__c">
          <stop stopColor="#DA7315" offset="0%" />
          <stop stopColor="#AF4A12" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="prefix__news__g">
          <stop stopColor="#FF9D5B" offset="0%" />
          <stop stopColor="#DC7531" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="prefix__news__h">
          <stop stopColor="#DA7315" offset="0%" />
          <stop stopColor="#E0631E" offset="100%" />
        </linearGradient>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="prefix__news__k">
          <stop stopColor="#F09500" offset="0%" />
          <stop stopColor="#FA6400" offset="100%" />
        </linearGradient>
        <filter
          x="-61.2%"
          y="-30.6%"
        ...
        >
          ...
          <feColorMatrix
            values="0 0 0 0 0.683338995 0 0 0 0 0.683338995 0 0 0 0 0.683338995 0 0 0 0.5 0"
            in="shadowBlurOuter1"
          />
        </filter>
        <filter
        ...
        >
          ...
          <feGaussianBlur stdDeviation="1.5" in="shadowOffsetOuter1" result="shadowBlurOuter1" />
          <feColorMatrix
            values="0 0 0 0 0.464928668 0 0 0 0 0.131801027 0 0 0 0 0.0324156631 0 0 0 1 0"
            in="shadowBlurOuter1"
          />
        </filter>
        <path id="prefix__news__f" d="M51.8 0v9.8h9.8z" />
        <path
          d="M40.198 56.706L72.8 86.8H0l32.602-30.094a5.6 5.6 0 017.596 0z"
          id="prefix__news__j"
        />
        <radialGradient
          cx="30.664%"
          ...
          fy="13.854%"
          r="147.262%"
          gradientTransform="scale(1 .85714) rotate(57.684 .286 .15)"
          id="prefix__news__d"
        >
          <stop stopColor="#FFF" offset="0%" />
          <stop stopColor="#E3E3E3" offset="100%" />
        </radialGradient>
        <circle id="prefix__news__a" cx="43" cy="43" r="42" />
      </defs>
      <g fill="none" fillRule="evenodd">
        <mask id="prefix__news__b" fill="#fff">
          <use xlinkHref="#prefix__news__a" />
        </mask>
        <use fill="#EBEBEB" xlinkHref="#prefix__news__a" />
        <g mask="url(#prefix__news__b)">
          <path
            fill="url(#prefix__news__c)"
            transform="translate(7 14)"
            d="M36.4 8.4l32.2 28.84V42H4.2v-4.76z"
          />
          <path
            stroke="#FCFCFC"
            strokeWidth="1.4"
            fill="url(#prefix__news__d)"
            d="M11.2 0h41.3l9.1 9.1v49.7H11.2z"
            transform="translate(7 14)"
          />
          <path fill="#C0B87B" d="M21 33.6h16.8v14H21z" />
          <path fill="#44D7B6" d="M21 19.6h14v2.8H21z" />
          <path
            d="M65.8 61.6v2.8H21v-2.8h44.8zm0-5.6v2.8H21V56h44.8zm0-5.6v2.8H21v-2.8h44.8zm0-5.6v2.8H40.6v-2.8h25.2zm0-5.6V42H40.6v-2.8h25.2zm0-5.6v2.8H40.6v-2.8h25.2zm-19.6-8.4V28H21v-2.8h25.2z"
            fill="#BBCFCB"
          />
          <g transform="translate(7 14)">
            <use fill="#000" filter="url(#prefix__news__e)" xlinkHref="#prefix__news__f" />
            <use fill="#FCFCFC" xlinkHref="#prefix__news__f" />
          </g>
          <path
            d="M21 42l23.8 33.6H-.093a1.4 1.4 0 01-1.142-2.21L21 42z"
            fill="url(#prefix__news__g)"
            transform="rotate(90 17.5 69.3)"
          />
          <path
            d="M51.8 42l23.8 33.6H30.707a1.4 1.4 0 01-1.142-2.21L51.8 42z"
            fill="url(#prefix__news__h)"
            transform="matrix(0 1 1 0 0 21)"
          />
          <g transform="matrix(-1 0 0 1 79.8 14)">
            <use fill="#000" filter="url(#prefix__news__i)" xlinkHref="#prefix__news__j" />
            <use fill="url(#prefix__news__k)" xlinkHref="#prefix__news__j" />
          </g>
        </g>
      </g>
    </svg>
...
export function RoadmapTitleBg(props: SvgIconProps) {
  return (
    <svg
      viewBox="0 0 1438 85"
    ...
    >
      <defs>
        <linearGradient x1="110%" y1="50%" x2="0%" y2="50%" id="rmtitle-prefix__a">
          <stop stopColor="#EEE" offset="0%" />
          <stop stopColor="#D7DCE0" offset=".722%" />
          <stop stopColor="#EDF2F7" offset="100%" />
        </linearGradient>
      </defs>
      <path
        d="M0 0h1386.573a4 4 0 012.532.903l47.106 38.5a4 4 0 010 6.194l-47.106 38.5a4 4 0 01-2.532.903H0V0z"
        fill="url(#rmtitle-prefix__a)"
        fillRule="evenodd"
      />
    </svg>
  )
